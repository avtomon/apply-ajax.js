...
(function (avtomon) {
    class ApplyAjax {
         ...
         */
        constructor({ _HIDE_CLASS = 'clone', _HOST = location.origin, _ALLOWED_ATTRS = ['class', 'text', 'val', 'value', 'id', 'src', 'title', 'href', 'data-object-src'], _DEFAULT_ERROR_CALLBACK = alert, _DEFAULT_HEADERS = {
            processData: true
        }, _DEFAULT_PARAMS = {
         ...
         */
        request(url, params, method, callback, callbackError, headers) {
            return __awaiter(this, void 0, void 0, function* () {
                if (!url) {
                    return new Error('URL запроса не задан');
                }
                let self = this, urlObject = new URL(this._HOST + url);
                if (method === 'GET') {
