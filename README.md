...
Ajax-запросы основаны на методе fetch, появившемся в недевно в JavaScript. Шаблонизация же поторяет принцип работы PHP-шаблонизатора [PQSkaTpl](https://github.com/avtomon/PQSkaTpl).

[Описание класса](docs_ru)
